                  ...
                  Column(
                      ...
                      const SizedBox(height: 6,),
                        ...
                        Row(
                          ...
                          const Text('from ',style:  TextStyle(fontSize: 16, ),),
                           Text('${userInfo.from}',style: const TextStyle( fontSize: 16) ,),
                          const Text(', living in  ',style: TextStyle(fontSize: 16),),
                          Text('${userInfo.livingIn}',style: const TextStyle(fontSize: 16) ,)
                        ],)
                   ...
                   Row(
                     ...
                     children: [
                      ...
                      Flexible(
                        child: TextButton(onPressed: () async{
                         ...
                         child:userInfo.mediaLink != ''?
                          Text('${userInfo.mediaLink}',style:  TextStyle(fontSize: 16, color: Colors.blue.shade700) ,)
                          : Container(
                    ...
                    Row(
                      ...
                      children: [
                        Flexible(child:
                        userInfo.bio != ''? Text('${userInfo.bio}',style: const TextStyle(fontSize: 16) ,): Container(
                            color:Colors.white12
                          )),
                      ],
                    ),
                   ...
                   InkWell(
                    onTap: () {
                       Navigator.push(context, CupertinoPageRoute(builder: (context) => const MyPosts()));
                    },
                     child: Row(
                       children: [
                         const Icon(CupertinoIcons.collections,size: 18,),
                         const SizedBox(width: 5,),
                         const Text('My posts', style: TextStyle(fontSize: 22),),
                         const Spacer(),
                         Icon(CupertinoIcons.chevron_forward,color: Colors.blue.shade700,)
                       ],
                     ),
                   ),
                   ...
                   InkWell(
                    onTap: () {
                       Navigator.push(context, CupertinoPageRoute(builder: (context) => const SavedPosts()));
                    },
                     child: Row(
                       children:  [
                         const Icon(CupertinoIcons.bookmark,size: 18),
                         const SizedBox(width: 4,),
                         const Text('Saved posts',style: TextStyle(fontSize: 22),),
                         const Spacer(),
                          Icon(CupertinoIcons.chevron_forward,color: Colors.blue.shade700,)
                       ],
                     ),
